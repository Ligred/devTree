        ...
        <DropdownMenu.Root>
          ...
          <DropdownMenu.Portal>
            <DropdownMenu.Content
              className="motion-surface border-border bg-card data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=open]:fade-in-0 data-[state=closed]:fade-out-0 data-[state=open]:zoom-in-95 data-[state=closed]:zoom-out-95 data-[side=bottom]:slide-in-from-top-1 z-50 min-w-40 rounded-md border p-1 shadow-md data-[state=closed]:duration-140 data-[state=open]:duration-220 motion-reduce:animate-none"
              onClick={(e) => e.stopPropagation()}
            >
              {deleteButton && (
                <DropdownMenu.Item
