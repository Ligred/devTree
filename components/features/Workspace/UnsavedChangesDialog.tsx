      ...
      <AlertDialogContent>
        ...
        <AlertDialogFooter className="flex-col gap-2 sm:flex-row">
          ...
          <button
            ...
            className="inline-flex items-center justify-center rounded-lg bg-indigo-600 px-4 py-2 text-sm font-medium text-white shadow-sm transition-colors hover:bg-indigo-700 focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 focus:outline-none dark:bg-indigo-500 dark:hover:bg-indigo-600"
          ...
          <button
            ...
            className="border-border bg-background text-destructive hover:bg-destructive/10 focus:ring-destructive inline-flex items-center justify-center rounded-lg border px-4 py-2 text-sm font-medium shadow-sm transition-colors focus:ring-2 focus:ring-offset-2 focus:outline-none"
          ...
          <button
            ...
            className="border-border bg-background text-foreground hover:bg-accent focus:ring-ring inline-flex items-center justify-center rounded-lg border px-4 py-2 text-sm font-medium shadow-sm transition-colors focus:ring-2 focus:ring-offset-2 focus:outline-none"
            onClick={onCancel}
          >
            {t('unsaved.cancel')}
          </button>
