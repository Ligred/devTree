        ...
        actions={
          isEditable ? (
            <select
              ...
              className="border-border bg-background text-foreground rounded border px-2 py-0.5 text-xs outline-none"
            ...
            <span className="border-border bg-background text-muted-foreground rounded border px-2 py-0.5 text-xs">
              {language ?? 'javascript'}
            </span>
          )
        }
