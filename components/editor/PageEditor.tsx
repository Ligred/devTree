...
// @ts-ignore — tiptap-extension-global-drag-handle ships CJS without types
...
export function PageEditor({ content, editable, onChange, pageId, onEditorReady, activeFilterTags = [] }: Readonly<Props>) {
  /**
