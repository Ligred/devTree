...
export const StreakCardDay1: StoryObj<typeof StreakCard> = {
  render: () => <StreakCard data={{ ...sampleSummaryBase, streakCurrent: 1, streakLongest: 1 }} loading={false} />,
...
export const DonutSingleType: StoryObj<typeof ContentTypeDonut> = {
  render: () => (
    <ContentTypeDonut
      data={{ ...sampleContent, blockTypeCounts: { text: 42 } }}
      loading={false}
    />
  ),
...
export const DonutEmpty: StoryObj<typeof ContentTypeDonut> = {
  render: () => <ContentTypeDonut data={{ ...sampleContent, blockTypeCounts: {} }} loading={false} />,
